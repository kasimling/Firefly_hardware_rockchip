#ifeq ($(filter vr stbvr, $(strip $(TARGET_BOARD_PLATFORM_PRODUCT))), )
...
PRODUCT_COPY_FILES += \
	...
	hardware/rockchip/camera/SiliconImage/isi/drv/OV13850/calib/OV13850_lens_50013A1.xml:system/etc/OV13850_lens_50013A1.xml
	
ifeq ($(strip $(TARGET_PRODUCT)), rk3399_firefly_aio_box)
PRODUCT_COPY_FILES += \
	hardware/rockchip/camera/Config/cam_board_rk3399_aio.xml:system/etc/cam_board.xml
else
PRODUCT_COPY_FILES += \
